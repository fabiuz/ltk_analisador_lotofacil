...
procedure CarregarPrimoNaoPrimoConsolidadoIntervaloConcurso(objControle: TStringGrid; concursoInicial, concursoFinal: integer);
...
implementation
 ...
 begin
   ...
   if Not (objControle is TStringGrid) then begin
     Exit;
   end;
...
procedure CarregarPrimoNaoPrimo(objControle: TStringGrid);
 const externo_interno_campos : array [0..4] of string = (
       'prm_id',
       'primo',
       'nao_primo',
       'ltf_qt',
 ...
 begin
   ...
   strSql.add('lotofacil.v_lotofacil_resultado_primo_nao_primo_agrupado');
...
procedure CarregarPrimoNaoPrimoConsolidadoIntervaloConcurso(
...
begin
  ...
  begin
    ...
    begin
      objControle.Cells[uA, uLinha] := IntToStr(dsLotofacil.FieldByName(primo_nao_primo_campos[uA]).AsInteger);
    end;
