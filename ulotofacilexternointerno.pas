...
procedure TExternoInterno.ConfigurarControlesExternoInternoPorConcurso(
...
procedure TExternoInterno.CarregarExternoInternoPorConcurso(
  objControle: TStringGrid);
const
  par_impar_campos: array[0..2] of string = (
    'concurso',
...
procedure TExternoInterno.ConfigurarControlesExternoInternoAgrupado(
  objControle: TStringGrid);
var
  qtColunas, indice_ultima_coluna, uA: integer;
  externo_interno_campos: array[0..5] of
...
procedure TExternoInterno.CarregarExternoInternoAgrupado(
  objControle: TStringGrid);
const
  externo_interno_campos: array[0..4] of string = (
    'ext_int_id',
...
procedure TExternoInterno.CarregarExternoInternoConsolidadoIntervaloConcurso(
  objControle: TStringGrid; concursoInicial, concursoFinal: integer);
const
  par_impar_campos: array[0..4] of string = (
    'ext_int_id',
