...
procedure exibir_status_da_comparacao_de_bolas_na_mesma_coluna(
  sql_conexao: TZConnection; sgr_controle: TStringGrid);
var
  sql_query: TZQuery;
...
procedure atualizar_status_da_comparacao_de_bolas_na_mesma_coluna(
